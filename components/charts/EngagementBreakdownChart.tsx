...
export default function EngagementBreakdownChart({ posts }: { posts: Post[] }) {
  ...
  return (
    <ChartCard title="Reactions, Comments & Shares by Post">
      <ResponsiveContainer width="100%" height={280}>
        <BarChart data={data} margin={{ top: 8, right: 8, left: 24, bottom: 24 }}>
          ...
          <Bar dataKey="Reactions" fill={CHART_COLORS.maroon} radius={[6, 6, 0, 0]} />
          <Bar dataKey="Comments" fill={CHART_COLORS.sienna} radius={[6, 6, 0, 0]} />
          <Bar dataKey="Shares" fill={CHART_COLORS.mustard} radius={[6, 6, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </ChartCard>
  );
